...
describe('ProductCategory Entity', () => {
  describe('Entity creation', () => {
    ...
    it('should create a level 3 product category with full ancestry', () => {
      const category = new ProductCategory(
        '3',
        new ProductCategoryNameVO('iPhone'),
        '100',
        '2', // parent ID
        3,
        '1', // grandparent
  ...
  describe('Business rules validation', () => {
    it('should throw error for invalid tenant ID (zero)', () => {
      ...
      ).toThrow('Tenant ID must be a positive number');
    });
  ...
  describe('Entity methods', () => {
    it('should check if category is active', () => {
      const activeCategory = new ProductCategory(
        '1',
        new ProductCategoryNameVO('Electronics'),
        '100',
        null,
      ...
      const inactiveCategory = new ProductCategory(
        '2',
        new ProductCategoryNameVO('Obsolete'),
        '100',
        null,
        1,
        null,
    ...
    it('should get ancestry path', () => {
      const level3Category = new ProductCategory(
        '3',
        new ProductCategoryNameVO('iPhone'),
        '100',
        '2',
